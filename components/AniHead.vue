...
const newRive = () => {
  const riveInstance = new Rive({
    ...
    onLoad: (_) => {
      getInputs(riveInstance.stateMachineInputs('default'))
      //   const inputs = riveInstance.stateMachineInputs('default')
      //   const isHappy = inputs.find((i) => i.name === 'isHappy')
      //   const isSad = inputs.find((i) => i.name === 'isSad')
      //   const agree = inputs.find((i) => i.name === 'agree')
      //   const disagree = inputs.find((i) => i.name === 'disagree')
      //   const x = inputs.find((i) => i.name === 'x')
      //   const y = inputs.find((i) => i.name === 'y')
      //   x.value = 50
      //   y.value = 50
    },
  })
